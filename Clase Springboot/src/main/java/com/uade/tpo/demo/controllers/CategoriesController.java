...
@RestController //marca la arquitectura de la clase como un controlador REST, lo que permite manejar solicitudes HTTP y devolver respuestas en formato JSON o XML.
