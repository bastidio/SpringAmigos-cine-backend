...
public interface EntradaRepository extends JpaRepository<Entrada, Long> {
    ...
    // Entradas emitidas por una orden: se resuelve con Query by Example desde el
    // service (entradaRepository.findAll(Example.of(probe))). No se puede hacer
    // derivada porque el campo se llama orden_id y el "_" lo interpreta Spring
    // Data como salto a una propiedad anidada 'orden' que no existe.
}